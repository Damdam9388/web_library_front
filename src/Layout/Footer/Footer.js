        ...
        return(
            <div>
                <div className="row text-center">
                    <div className="col-md-3 bg-dark pt-5">
                    ...
                    <div className="col-md-3 text-white bg-dark pt-5">
                ...
                <div className="row follow_links bg-dark pt-5">
                ...
                <div className="row condition pb-2 bg-dark pt-3 pb-3">
                    <div className="col-md-12 text-center">
